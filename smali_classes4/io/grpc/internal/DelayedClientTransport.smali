...
# instance fields
.field public final defaultAppExecutor:Ljava/util/concurrent/Executor;

.field public lastPicker:Lio/grpc/Grpc;

.field public lastPickerVersion:J

.field public listener:Lokhttp3/ConnectionPool;

.field public final lock:Ljava/lang/Object;

.field public final logId:Lio/grpc/InternalLogId;

.field public pendingStreams:Ljava/util/Collection;

.field public reportTransportInUse:Lio/grpc/internal/DelayedClientTransport$1;

.field public reportTransportNotInUse:Lio/grpc/internal/DelayedClientTransport$1;

.field public reportTransportTerminated:Lio/grpc/internal/DelayedClientTransport$1;
...
# virtual methods
.method public final createPendingStream(Lio/grpc/internal/PickSubchannelArgsImpl;[Lio/grpc/ClientStreamTracer;)Lio/grpc/internal/DelayedClientTransport$PendingStream;
    .locals 3
    ...
    .line 2
    .line 3
    invoke-direct {v0, p0, p1, p2}, Lio/grpc/internal/DelayedClientTransport$PendingStream;-><init>(Lio/grpc/internal/DelayedClientTransport;Lio/grpc/internal/PickSubchannelArgsImpl;[Lio/grpc/ClientStreamTracer;)V
    ...
    .line 25
    .line 26
    iget-object v1, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportInUse:Lio/grpc/internal/DelayedClientTransport$1;
...
.method public final newStream(Lio/grpc/MethodDescriptor;Lio/grpc/Metadata;Lio/grpc/CallOptions;[Lio/grpc/ClientStreamTracer;)Lio/grpc/internal/ClientStream;
    ...
    .line 19
    .line 20
    invoke-direct {p1, v3, p3, p4}, Lio/grpc/internal/FailingClientStream;-><init>(Lio/grpc/Status;Lio/grpc/internal/ClientStreamListener$RpcProgress;[Lio/grpc/ClientStreamTracer;)V
    ...
    :cond_0
    :try_start_2
    iget-object v3, p0, Lio/grpc/internal/DelayedClientTransport;->lastPicker:Lio/grpc/Grpc;
    ...
    .line 35
    .line 36
    invoke-virtual {p0, v0, p4}, Lio/grpc/internal/DelayedClientTransport;->createPendingStream(Lio/grpc/internal/PickSubchannelArgsImpl;[Lio/grpc/ClientStreamTracer;)Lio/grpc/internal/DelayedClientTransport$PendingStream;
    ...
    .line 59
    :try_start_3
    invoke-virtual {v3, v0}, Lio/grpc/Grpc;->pickSubchannel(Lio/grpc/internal/PickSubchannelArgsImpl;)Lio/grpc/LoadBalancer$PickResult;
    ...
    .line 64
    .line 65
    iget-object v4, p3, Lio/grpc/CallOptions;->waitForReady:Ljava/lang/Boolean;
    ...
    .line 76
    .line 77
    iget-object p2, v0, Lio/grpc/internal/PickSubchannelArgsImpl;->method:Lio/grpc/MethodDescriptor;

    .line 78
    .line 79
    iget-object p3, v0, Lio/grpc/internal/PickSubchannelArgsImpl;->headers:Lio/grpc/Metadata;
...
.method public final reprocess(Lio/grpc/Grpc;)V
    .locals 11
    ...
    .line 4
    :try_start_0
    iput-object p1, p0, Lio/grpc/internal/DelayedClientTransport;->lastPicker:Lio/grpc/Grpc;
    ...
    .line 51
    .line 52
    iget-object v3, v2, Lio/grpc/internal/DelayedClientTransport$PendingStream;->args:Lio/grpc/internal/PickSubchannelArgsImpl;

    .line 53
    .line 54
    invoke-virtual {p1, v3}, Lio/grpc/Grpc;->pickSubchannel(Lio/grpc/internal/PickSubchannelArgsImpl;)Lio/grpc/LoadBalancer$PickResult;
    ...
    .line 58
    iget-object v4, v2, Lio/grpc/internal/DelayedClientTransport$PendingStream;->args:Lio/grpc/internal/PickSubchannelArgsImpl;

    .line 59
    .line 60
    iget-object v4, v4, Lio/grpc/internal/PickSubchannelArgsImpl;->callOptions:Lio/grpc/CallOptions;
    ...
    .line 63
    .line 64
    iget-object v6, v4, Lio/grpc/CallOptions;->waitForReady:Ljava/lang/Boolean;
    ...
    .line 77
    .line 78
    iget-object v4, v4, Lio/grpc/CallOptions;->executor:Ljava/util/concurrent/Executor;
    ...
    .line 83
    :cond_2
    iget-object v4, v2, Lio/grpc/internal/DelayedClientTransport$PendingStream;->context:Lio/grpc/Context;
    ...
    .line 89
    :try_start_1
    iget-object v7, v2, Lio/grpc/internal/DelayedClientTransport$PendingStream;->args:Lio/grpc/internal/PickSubchannelArgsImpl;

    .line 90
    .line 91
    iget-object v8, v7, Lio/grpc/internal/PickSubchannelArgsImpl;->method:Lio/grpc/MethodDescriptor;

    .line 92
    .line 93
    iget-object v9, v7, Lio/grpc/internal/PickSubchannelArgsImpl;->headers:Lio/grpc/Metadata;

    .line 94
    .line 95
    iget-object v7, v7, Lio/grpc/internal/PickSubchannelArgsImpl;->callOptions:Lio/grpc/CallOptions;

    .line 96
    .line 97
    iget-object v10, v2, Lio/grpc/internal/DelayedClientTransport$PendingStream;->tracers:[Lio/grpc/ClientStreamTracer;

    .line 98
    .line 99
    invoke-interface {v3, v8, v9, v7, v10}, Lio/grpc/internal/ClientTransport;->newStream(Lio/grpc/MethodDescriptor;Lio/grpc/Metadata;Lio/grpc/CallOptions;[Lio/grpc/ClientStreamTracer;)Lio/grpc/internal/ClientStream;
    ...
    .line 103
    invoke-virtual {v4, v6}, Lio/grpc/Context;->detach(Lio/grpc/Context;)V

    .line 104
    .line 105
    .line 106
    invoke-virtual {v2, v3}, Lio/grpc/internal/DelayedClientTransport$PendingStream;->setStream(Lio/grpc/internal/ClientStream;)Lio/grpc/internal/DelayedStream$4;
    ...
    .line 164
    .line 165
    iget-object v1, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportNotInUse:Lio/grpc/internal/DelayedClientTransport$1;
    ...
    .line 173
    .line 174
    iget-object v0, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportTerminated:Lio/grpc/internal/DelayedClientTransport$1;
    ...
    .line 184
    iput-object v0, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportTerminated:Lio/grpc/internal/DelayedClientTransport$1;
...
.method public final shutdown(Lio/grpc/Status;)V
    ...
    .line 30
    .line 31
    iget-object p1, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportTerminated:Lio/grpc/internal/DelayedClientTransport$1;
    ...
    .line 41
    iput-object p1, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportTerminated:Lio/grpc/internal/DelayedClientTransport$1;
...
.method public final start(Lio/grpc/internal/ManagedClientTransport$Listener;)Ljava/lang/Runnable;
    ...
    .line 2
    .line 3
    iput-object p1, p0, Lio/grpc/internal/DelayedClientTransport;->listener:Lokhttp3/ConnectionPool;
    ...
    .line 8
    invoke-direct {v0, p1, v1}, Lio/grpc/internal/DelayedClientTransport$1;-><init>(Lokhttp3/ConnectionPool;I)V

    .line 9
    .line 10
    .line 11
    iput-object v0, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportInUse:Lio/grpc/internal/DelayedClientTransport$1;
    ...
    .line 18
    .line 19
    iput-object v0, p0, Lio/grpc/internal/DelayedClientTransport;->reportTransportNotInUse:Lio/grpc/internal/DelayedClientTransport$1;
