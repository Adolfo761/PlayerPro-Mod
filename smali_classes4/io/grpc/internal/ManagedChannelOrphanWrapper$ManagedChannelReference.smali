.class public final Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;
.super Ljava/lang/ref/WeakReference;
.source "SourceFile"


# static fields
.field public static final ENABLE_ALLOCATION_TRACKING:Z

.field public static final missingCallSite:Ljava/lang/RuntimeException;


# instance fields
.field public final allocationSite:Ljava/lang/ref/SoftReference;

.field public final channelStr:Ljava/lang/String;

.field public final refqueue:Ljava/lang/ref/ReferenceQueue;

.field public final refs:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>(Lio/grpc/internal/ManagedChannelOrphanWrapper;Lio/grpc/internal/ManagedChannelImpl;Ljava/lang/ref/ReferenceQueue;Ljava/util/concurrent/ConcurrentHashMap;)V
    .locals 2
    ...
    .line 29
    .line 30
    iput-object p1, p0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->allocationSite:Ljava/lang/ref/SoftReference;

    .line 31
    .line 32
    invoke-virtual {p2}, Lio/grpc/internal/ManagedChannelImpl;->toString()Ljava/lang/String;
    ...
    .line 39
    .line 40
    iput-object p4, p0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->refs:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 44
    .line 45
    invoke-static {p3}, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->cleanQueue(Ljava/lang/ref/ReferenceQueue;)V
...
.method public static cleanQueue(Ljava/lang/ref/ReferenceQueue;)V
    .locals 6
    ...
    .line 5
    check-cast v0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;
    ...
    .line 8
    .line 9
    iget-object v1, v0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->allocationSite:Ljava/lang/ref/SoftReference;
    ...
    .line 19
    .line 20
    iget-object v3, v0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->refs:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 27
    .line 28
    iget-object v1, v0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->shutdown:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 37
    .line 38
    sget-object v3, Lio/grpc/internal/ManagedChannelOrphanWrapper;->logger:Ljava/util/logging/Logger;
    ...
    .line 82
    .line 83
    iget-object v0, v0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->channelStr:Ljava/lang/String;
...
.method public final clear()V
    ...
    .line 3
    .line 4
    iget-object v0, p0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->refs:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 8
    .line 9
    iget-object v0, p0, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->allocationSite:Ljava/lang/ref/SoftReference;
    ...
    .line 15
    .line 16
    invoke-static {v0}, Lio/grpc/internal/ManagedChannelOrphanWrapper$ManagedChannelReference;->cleanQueue(Ljava/lang/ref/ReferenceQueue;)V
