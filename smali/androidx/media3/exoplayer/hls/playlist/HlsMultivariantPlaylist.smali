...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Landroidx/media3/common/Format;Ljava/util/List;ZLjava/util/Map;Ljava/util/List;)V
    ...
    .line 20
    check-cast p10, Landroidx/media3/exoplayer/hls/playlist/HlsMultivariantPlaylist$Variant;

    .line 21
    .line 22
    iget-object p10, p10, Landroidx/media3/exoplayer/hls/playlist/HlsMultivariantPlaylist$Variant;->url:Landroid/net/Uri;
    ...
    .line 36
    :cond_1
    invoke-static {p4, p1}, Landroidx/media3/exoplayer/hls/playlist/HlsMultivariantPlaylist;->addMediaPlaylistUrls(Ljava/util/List;Ljava/util/ArrayList;)V

    .line 37
    .line 38
    .line 39
    invoke-static {p5, p1}, Landroidx/media3/exoplayer/hls/playlist/HlsMultivariantPlaylist;->addMediaPlaylistUrls(Ljava/util/List;Ljava/util/ArrayList;)V

    .line 40
    .line 41
    .line 42
    invoke-static {p6, p1}, Landroidx/media3/exoplayer/hls/playlist/HlsMultivariantPlaylist;->addMediaPlaylistUrls(Ljava/util/List;Ljava/util/ArrayList;)V

    .line 43
    .line 44
    .line 45
    invoke-static {p7, p1}, Landroidx/media3/exoplayer/hls/playlist/HlsMultivariantPlaylist;->addMediaPlaylistUrls(Ljava/util/List;Ljava/util/ArrayList;)V
...
.method public static addMediaPlaylistUrls(Ljava/util/List;Ljava/util/ArrayList;)V
    .locals 3
...
.method public static copyStreams(Ljava/util/List;Ljava/util/List;I)Ljava/util/ArrayList;
    .locals 7
...
.method public final copy(Ljava/util/List;)Ljava/lang/Object;
    ...
    .line 6
    invoke-static {v0, p1, v1}, Landroidx/media3/exoplayer/hls/playlist/HlsMultivariantPlaylist;->copyStreams(Ljava/util/List;Ljava/util/List;I)Ljava/util/ArrayList;
