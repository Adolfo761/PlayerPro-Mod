...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ironsource/ho;->f:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/ironsource/ho;->a:Lcom/iab/omid/library/ironsrc/adsession/Partner;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/ironsource/ho;->c:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/ironsource/ho;->b:Ljava/util/HashMap;

    return-void
.end method

.method private a(Lcom/ironsource/ho$a;Lcom/ironsource/vh;)Lcom/iab/omid/library/ironsrc/adsession/AdSession;
    .locals 5

    .line 1
    iget-object v0, p1, Lcom/ironsource/ho$a;->f:Lcom/iab/omid/library/ironsrc/adsession/CreativeType;

    iget-object v1, p1, Lcom/ironsource/ho$a;->e:Lcom/iab/omid/library/ironsrc/adsession/ImpressionType;

    iget-object v2, p1, Lcom/ironsource/ho$a;->b:Lcom/iab/omid/library/ironsrc/adsession/Owner;

    iget-object v3, p1, Lcom/ironsource/ho$a;->c:Lcom/iab/omid/library/ironsrc/adsession/Owner;

    iget-boolean v4, p1, Lcom/ironsource/ho$a;->a:Z
    ...
    iget-object v1, p0, Lcom/ironsource/ho;->a:Lcom/iab/omid/library/ironsrc/adsession/Partner;

    invoke-interface {p2}, Lcom/ironsource/vh;->getPresentingView()Landroid/webkit/WebView;

    move-result-object v2

    iget-object p1, p1, Lcom/ironsource/ho$a;->d:Ljava/lang/String;
...
# virtual methods
.method public a()Lcom/ironsource/fr;
    .locals 3
    ...
    invoke-virtual {v0, v2, v1}, Lcom/ironsource/fr;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/ironsource/ho;->b:Ljava/util/HashMap;
...
.method public a(Landroid/content/Context;)V
    ...
    iput-boolean p1, p0, Lcom/ironsource/ho;->c:Z

    :cond_0
    return-void
.end method

.method public a(Lcom/ironsource/ho$a;)V
    .locals 2
    ...
    iget-object v0, p1, Lcom/ironsource/ho$a;->g:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1}, Lcom/ironsource/ho;->a(Lcom/ironsource/ho$a;Lcom/ironsource/vh;)Lcom/iab/omid/library/ironsrc/adsession/AdSession;
...
.method public b(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0, p1}, Lcom/ironsource/ho;->a(Lorg/json/JSONObject;)V
    ...
    iget-object v0, p0, Lcom/ironsource/ho;->b:Ljava/util/HashMap;
...
.method public d(Lorg/json/JSONObject;)V
    ...
    invoke-static {p1}, Lcom/ironsource/ho$a;->a(Lorg/json/JSONObject;)Lcom/ironsource/ho$a;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/ironsource/ho;->a(Lcom/ironsource/ho$a;)V
