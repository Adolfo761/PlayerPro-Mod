...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/ironsource/z7;->a(Ljava/util/List;Lcom/ironsource/z7$b;JLjava/util/concurrent/TimeUnit;)V
.end annotation
...
# instance fields
.field final synthetic a:Lcom/ironsource/z7$b;

.field final synthetic b:Lcom/ironsource/z7;


# direct methods
.method public constructor <init>(Lcom/ironsource/z7;Lcom/ironsource/z7$b;)V
    .locals 0

    iput-object p1, p0, Lcom/ironsource/z7$a;->b:Lcom/ironsource/z7;

    iput-object p2, p0, Lcom/ironsource/z7$a;->a:Lcom/ironsource/z7$b;
...
.method public onWorkCompleted(Ljava/util/List;J)V
    ...
    check-cast v2, Lcom/ironsource/a8;
    ...
    check-cast v2, Lcom/ironsource/w7;

    invoke-virtual {v2}, Lcom/ironsource/w7;->c()Ljava/lang/String;
    ...
    check-cast v3, Lcom/ironsource/w7;

    new-instance v11, Lcom/ironsource/a8;

    invoke-virtual {v3}, Lcom/ironsource/w7;->d()I

    move-result v5

    invoke-virtual {v3}, Lcom/ironsource/w7;->c()Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/ironsource/a8;-><init>(ILjava/lang/String;Ljava/util/Map;JLjava/lang/String;)V
    ...
    :cond_3
    iget-object p1, p0, Lcom/ironsource/z7$a;->b:Lcom/ironsource/z7;

    invoke-static {p1, v1, v0, p2, p3}, Lcom/ironsource/z7;->a(Lcom/ironsource/z7;Ljava/util/List;Ljava/util/List;J)V

    iget-object p1, p0, Lcom/ironsource/z7$a;->a:Lcom/ironsource/z7$b;

    invoke-interface {p1, v1, p2, p3, v0}, Lcom/ironsource/z7$b;->a(Ljava/util/List;JLjava/util/List;)V
...
.method public onWorkFailed(Ljava/lang/String;)V
    ...
    .line 11
    .line 12
    iget-object v0, p0, Lcom/ironsource/z7$a;->a:Lcom/ironsource/z7$b;

    .line 13
    .line 14
    invoke-interface {v0, p1}, Lcom/ironsource/z7$b;->onFailure(Ljava/lang/String;)V
