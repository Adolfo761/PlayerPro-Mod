...
.method public static synthetic a(Lcom/ironsource/z7;Ljava/util/List;Ljava/util/List;J)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/ironsource/z7;->a(Ljava/util/List;Ljava/util/List;J)V
...
.method private a(Ljava/util/List;Ljava/util/List;J)V
    ...
    check-cast p3, Lcom/ironsource/a8;

    invoke-virtual {p3}, Lcom/ironsource/a8;->a()Ljava/util/Map;
    ...
    invoke-virtual {p3}, Lcom/ironsource/a8;->c()Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/ironsource/a8;->e()J
    ...
    invoke-virtual {p3}, Lcom/ironsource/a8;->b()Ljava/lang/String;
...
# virtual methods
.method public a(Ljava/util/List;Lcom/ironsource/z7$b;JLjava/util/concurrent/TimeUnit;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance p1, Lcom/ironsource/z7$a;

    invoke-direct {p1, p0, p2}, Lcom/ironsource/z7$a;-><init>(Lcom/ironsource/z7;Lcom/ironsource/z7$b;)V
    ...
    .line 2
    invoke-static {p3, p1}, Lcom/ironsource/a0$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {p2, p1}, Lcom/ironsource/z7$b;->onFailure(Ljava/lang/String;)V
