...
.field private static b:Lcom/ironsource/rt; = null
...
.method private static a(Landroid/content/Context;)V
    ...
    .line 1
    sget-object v0, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/rt;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/ironsource/rt;->b()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/rt;->c()Z
...
.method private static a()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/rt;->a()Z
...
.method private static b(Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/rt;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/ironsource/rt;->d()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0, p0}, Lcom/ironsource/nf;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/nf;->u(Landroid/content/Context;)Ljava/io/File;
...
.method private static b(Ljava/io/File;)Ljava/io/File;
    ...
    .line 2
    invoke-static {v1, p0, v2, p0}, Landroidx/compose/animation/core/Animation$-CC;->m(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static buildAbsolutePathToDirInCache(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 9
    .line 10
    invoke-static {p0, v0, p1}, Landroidx/compose/foundation/layout/RowScope$-CC;->m(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static buildFilesMapOfDirectory(Lcom/ironsource/nh;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 6
    ...
    invoke-direct {v4, v3}, Lcom/ironsource/nh;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4, p1}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->buildFilesMapOfDirectory(Lcom/ironsource/nh;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method private static c(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/nf;->k(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/nf;->x(Landroid/content/Context;)Ljava/io/File;
...
.method public static declared-synchronized deleteFile(Lcom/ironsource/nh;)Z
    .locals 2
...
.method public static ensurePathSafety(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/rt;->e()Z
...
.method public static getFilesInFolderRecursive(Lcom/ironsource/nh;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-static {v4}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getFilesInFolderRecursive(Lcom/ironsource/nh;)Ljava/util/ArrayList;
...
.method public static getTotalSizeOfDir(Lcom/ironsource/nh;)J
    .locals 6
    ...
    invoke-direct {v5, v4}, Lcom/ironsource/nh;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getTotalSizeOfDir(Lcom/ironsource/nh;)J
...
.method public static initializeCacheDirectory(Landroid/content/Context;Lcom/ironsource/rt;)V
    .locals 0

    sput-object p1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/rt;
...
.method public static readFile(Lcom/ironsource/nh;)Ljava/lang/String;
    .locals 3
