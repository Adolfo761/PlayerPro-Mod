...
.implements Lcom/ironsource/bg$a;
...
.method private a(Lcom/ironsource/pp;)J
    .locals 8
    ...
    sget-object v1, Lcom/ironsource/op$a;->a:[I
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2, v0, p3}, Lcom/ironsource/op;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p2, v3, p3}, Lcom/ironsource/op;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    sget-object v4, Lcom/ironsource/pp;->b:Lcom/ironsource/pp;

    invoke-virtual {v4}, Lcom/ironsource/pp;->toString()Ljava/lang/String;
    ...
    invoke-static {}, Lcom/ironsource/pp;->values()[Lcom/ironsource/pp;
    ...
    iget-object v7, v6, Lcom/ironsource/pp;->a:Ljava/lang/String;
    ...
    :goto_1
    invoke-direct {p0, v6}, Lcom/ironsource/op;->a(Lcom/ironsource/pp;)J

    move-result-wide v3

    const-string v1, "CappingManager.CAPPING_TIME_THRESHOLD"

    invoke-direct {p0, p2, v1, p3}, Lcom/ironsource/op;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/ironsource/lp;)V
    .locals 2

    .line 7
    invoke-virtual {p4}, Lcom/ironsource/lp;->e()Z
    ...
    :cond_0
    invoke-virtual {p4}, Lcom/ironsource/lp;->d()Z
    ...
    invoke-virtual {p4}, Lcom/ironsource/lp;->b()I
    ...
    invoke-virtual {p4}, Lcom/ironsource/lp;->a()Lcom/ironsource/pp;
    ...
    invoke-virtual {v0}, Lcom/ironsource/pp;->toString()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p4}, Lcom/ironsource/lp;->f()Z
    ...
    invoke-virtual {p4}, Lcom/ironsource/lp;->c()I
...
.method private b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/ironsource/op$b;
    .locals 10
    ...
    invoke-direct {p0, p2, v2, p3}, Lcom/ironsource/op;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object p1, Lcom/ironsource/op$b;->a:Lcom/ironsource/op$b;
    ...
    sget-object p1, Lcom/ironsource/op$b;->c:Lcom/ironsource/op$b;
    ...
    invoke-direct {p0, p2, v6, p3}, Lcom/ironsource/op;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p2, v8, p3}, Lcom/ironsource/op;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object p1, Lcom/ironsource/op$b;->b:Lcom/ironsource/op$b;
...
# virtual methods
.method public declared-synchronized a(Landroid/content/Context;Lcom/ironsource/mediationsdk/model/BasePlacement;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)Lcom/ironsource/op$b;
    .locals 1
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0, p3}, Lcom/ironsource/op;->a(Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)Ljava/lang/String;
    ...
    :cond_2
    :try_start_3
    invoke-virtual {p2}, Lcom/ironsource/mediationsdk/model/BasePlacement;->getPlacementAvailabilitySettings()Lcom/ironsource/lp;
    ...
    invoke-direct {p0, p1, p3, p2}, Lcom/ironsource/op;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/ironsource/op$b;
...
.method public declared-synchronized a(Landroid/content/Context;Ljava/lang/String;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    ...
    invoke-direct {p0, p1, p3, p2}, Lcom/ironsource/op;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized b(Landroid/content/Context;Lcom/ironsource/mediationsdk/model/BasePlacement;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/ironsource/op;->a(Landroid/content/Context;Lcom/ironsource/mediationsdk/model/BasePlacement;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)Lcom/ironsource/op$b;

    move-result-object p1

    sget-object p2, Lcom/ironsource/op$b;->d:Lcom/ironsource/op$b;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized c(Landroid/content/Context;Lcom/ironsource/mediationsdk/model/BasePlacement;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Lcom/ironsource/op;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/ironsource/lp;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
