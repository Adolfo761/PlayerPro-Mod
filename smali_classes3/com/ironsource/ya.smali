...
.method private static a(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-interface {v1}, Lcom/ironsource/xf;->f()Lcom/ironsource/nf;
    ...
    invoke-interface {v1, p0}, Lcom/ironsource/nf;->c(Landroid/content/Context;)Z
...
.method private static b(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/nf;->y(Landroid/content/Context;)I
...
.method private static b(Lorg/json/JSONObject;)V
    ...
    invoke-interface {v1}, Lcom/ironsource/nf;->c()Z
...
.method public static c(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    invoke-interface {v1, p0}, Lcom/ironsource/nf;->h(Landroid/content/Context;)J
    ...
    :cond_7
    invoke-static {p0}, Lcom/ironsource/c4;->g(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_8
    invoke-interface {v1}, Lcom/ironsource/nf;->h()F
    ...
    :cond_a
    invoke-static {p0}, Lcom/ironsource/dp;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/ironsource/x8;->f(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/ironsource/x8;->g(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/ironsource/c4;->f(Landroid/content/Context;)J
    ...
    invoke-static {p0}, Lcom/ironsource/c4;->d(Landroid/content/Context;)J
    ...
    invoke-static {p0}, Lcom/ironsource/c4;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/ironsource/dp;->c(Landroid/content/Context;)Ljava/lang/Integer;

    move-result-object v2

    invoke-virtual {v3, v0, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    invoke-static {p0}, Lcom/ironsource/c4;->e(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-interface {v1}, Lcom/ironsource/nf;->j()J
    ...
    invoke-interface {v1}, Lcom/ironsource/nf;->q()I
    ...
    invoke-interface {v1, p0}, Lcom/ironsource/nf;->n(Landroid/content/Context;)Ljava/lang/String;
...
.method private static c(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-interface {v1, p0}, Lcom/ironsource/nf;->l(Landroid/content/Context;)I
...
.method private static d(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    :try_start_0
    invoke-static {p0}, Lcom/ironsource/y8;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/ironsource/y8;->e(Landroid/content/Context;)Z
...
.method private static f(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-interface {v1, p0}, Lcom/ironsource/nf;->J(Landroid/content/Context;)Z
...
.method private static g(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/nf;->q(Landroid/content/Context;)Z
...
.method private static h(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-interface {v1, p0}, Lcom/ironsource/nf;->d(Landroid/content/Context;)Z
