...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/ProgressiveMediaPeriod;Lcom/google/android/exoplayer2/extractor/TrackOutput;Landroidx/media3/extractor/wav/WavFormat;)V
    .locals 5
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->extractorOutput:Lcom/google/android/exoplayer2/source/ProgressiveMediaPeriod;
    ...
    .line 7
    .line 8
    iput-object p3, p0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->wavFormat:Landroidx/media3/extractor/wav/WavFormat;
    ...
    .line 19
    iput p2, p0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->targetSampleSizeFrames:I
    ...
    .line 35
    iput v1, p0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->framesPerBlock:I
    ...
    .line 91
    .line 92
    iput v4, p3, Lcom/google/android/exoplayer2/Format$Builder;->averageBitrate:I

    .line 93
    .line 94
    iput v4, p3, Lcom/google/android/exoplayer2/Format$Builder;->peakBitrate:I
    ...
    .line 100
    .line 101
    iput p2, p3, Lcom/google/android/exoplayer2/Format$Builder;->maxInputSize:I

    .line 102
    .line 103
    iput v2, p3, Lcom/google/android/exoplayer2/Format$Builder;->channelCount:I
    ...
    .line 106
    .line 107
    iput v0, p3, Lcom/google/android/exoplayer2/Format$Builder;->pcmEncoding:I
    ...
    .line 110
    .line 111
    invoke-direct {p1, p3}, Lcom/google/android/exoplayer2/Format;-><init>(Lcom/google/android/exoplayer2/Format$Builder;)V
...
.method public final init(IJ)V
    ...
    .line 1
    new-instance v7, Lcom/google/android/exoplayer2/extractor/wav/WavSeekMap;
    ...
    .line 4
    iget-object v1, p0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->wavFormat:Landroidx/media3/extractor/wav/WavFormat;

    .line 5
    .line 6
    iget v2, p0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->framesPerBlock:I
    ...
    .line 10
    invoke-direct/range {v0 .. v6}, Lcom/google/android/exoplayer2/extractor/wav/WavSeekMap;-><init>(Landroidx/media3/extractor/wav/WavFormat;IJJ)V

    .line 11
    .line 12
    .line 13
    iget-object p1, p0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->extractorOutput:Lcom/google/android/exoplayer2/source/ProgressiveMediaPeriod;

    .line 14
    .line 15
    invoke-virtual {p1, v7}, Lcom/google/android/exoplayer2/source/ProgressiveMediaPeriod;->seekMap(Lcom/google/android/exoplayer2/extractor/SeekMap;)V
...
.method public final sampleData(Lcom/google/android/exoplayer2/extractor/DefaultExtractorInput;J)Z
    .locals 25
    ...
    .line 4
    .line 5
    iget v3, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->pendingOutputBytes:I

    .line 6
    .line 7
    iget-object v4, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->wavFormat:Landroidx/media3/extractor/wav/WavFormat;
    ...
    .line 14
    iget v5, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->targetSampleSizeFrames:I
    ...
    .line 17
    .line 18
    iget v6, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->framesPerBlock:I

    .line 19
    .line 20
    invoke-static {v3, v6}, Lcom/google/android/exoplayer2/util/Util;->ceilDivide(II)I
    ...
    .line 40
    .line 41
    iget v12, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->pendingInputBytes:I
    ...
    .line 56
    .line 57
    invoke-virtual {v14, v10, v12, v13}, Lcom/google/android/exoplayer2/extractor/DefaultExtractorInput;->read([BII)I
    ...
    .line 68
    iput v12, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->pendingInputBytes:I
    ...
    .line 85
    .line 86
    iget-object v14, v3, Lcom/google/android/exoplayer2/util/ParsableByteArray;->data:[B
    ...
    .line 130
    sget-object v19, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->STEP_TABLE:[I
    ...
    .line 216
    .line 217
    invoke-static {v8, v10, v15}, Lcom/google/android/exoplayer2/util/Util;->constrainValue(III)I
    ...
    .line 236
    .line 237
    sget-object v10, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->INDEX_TABLE:[I
    ...
    .line 244
    .line 245
    invoke-static {v11, v5, v10}, Lcom/google/android/exoplayer2/util/Util;->constrainValue(III)I
    ...
    .line 307
    .line 308
    iget v1, v3, Lcom/google/android/exoplayer2/util/ParsableByteArray;->limit:I

    .line 309
    .line 310
    iget-object v2, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->trackOutput:Lcom/google/android/exoplayer2/extractor/TrackOutput;

    .line 311
    .line 312
    invoke-interface {v2, v1, v3}, Lcom/google/android/exoplayer2/extractor/TrackOutput;->sampleData$1(ILcom/google/android/exoplayer2/util/ParsableByteArray;)V
    ...
    .line 318
    iput v2, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->pendingOutputBytes:I
...
.method public final writeSampleMetadata(I)V
    ...
    .line 4
    .line 5
    iget-wide v2, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->startTimeUs:J

    .line 6
    .line 7
    iget-wide v4, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->outputFrameCount:J

    .line 8
    .line 9
    iget-object v10, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->wavFormat:Landroidx/media3/extractor/wav/WavFormat;

    .line 10
    .line 11
    iget v6, v10, Landroidx/media3/extractor/wav/WavFormat;->frameRateHz:I
    ...
    .line 24
    .line 25
    iget v3, v10, Landroidx/media3/extractor/wav/WavFormat;->numChannels:I
    ...
    .line 34
    .line 35
    iget-object v11, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->trackOutput:Lcom/google/android/exoplayer2/extractor/TrackOutput;
    ...
    .line 41
    .line 42
    iget-wide v3, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->outputFrameCount:J
    ...
    .line 46
    iput-wide v3, v0, Lcom/google/android/exoplayer2/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->outputFrameCount:J
